...
export const GlobalStyle = createGlobalStyle`
  ...
  src: url('./iconfont.eot?t=1567399626308'); /* IE9 */
  src: url('./iconfont.eot?t=1567399626308#iefix') format('embedded-opentype'), /* IE6-IE8 */
  ...
  url('./iconfont.woff?t=1567399626308') format('woff'),
  url('./iconfont.ttf?t=1567399626308') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
  url('./iconfont.svg?t=1567399626308#iconfont') format('svg'); /* iOS 4.1- */
  }
